...
const NewTask = ({data}) => {
  return (
    <div className="bg-emerald-400 shrink-0 px-4 py-3  rounded-2xl h-full w-[300px]">
      ...
      <div className="flex justify-between mt-4 items-center">
        <button className="bg-blue-500 px-2 py-1 text-sm rounded">Accept the Task</button>
      </div>
    </div>
  );
};
